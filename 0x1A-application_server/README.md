...
2. Serve a page with Nginx mandatory - [2-app_server-nginx_config](2-app_server-nginx_config/)
...
3. Add a route with query parameters mandatory - [3-app_server-nginx_config](3-app_server-nginx_config/)
...
4. Let's do this for your API mandatory - [4-app_server-nginx_config](4-app_server-nginx_config/)
...
5. Serve your AirBnB clone mandatory - [5-app_server-nginx_config](5-app_server-nginx_config/)
